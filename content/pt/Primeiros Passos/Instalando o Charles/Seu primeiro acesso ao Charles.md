...
{{% alert color="info" %}}
Para mais informações de como mudar o host do seu sistema, [**acesse este tutorial**](https://www.howtogeek.com/howto/27350/beginner-geek-how-to-edit-your-hosts-file/). 
{{% /alert %}}
...
**Passo 2:** Adicione a linha abaixo no seu arquivo de host do OS \([**veja os passos de como mudar o host**](https://www.howtogeek.com/howto/27350/beginner-geek-how-to-edit-your-hosts-file/)\) caso você queira acessar do browser da sua máquina:
