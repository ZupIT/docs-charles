...
weight: 84
description: >-
  In this section, you will find an example how to make a deployment of an
...
{{% alert color="info" %}}
 To run this use case, you must already have a defined workspace, to know more about it, [**check Defining a workspace section**](/get-started/defining-a-workspace/overview/).
{{% /alert %}}
...
To access the Circles Sample chart template,[ **check out this repository**](https://api.github.com/repos/zupit/charlescd/contents/samples/circles). If you have any doubts about this configuration, check here for a **step-by-step reference**. 
